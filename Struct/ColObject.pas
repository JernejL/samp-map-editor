...
uses
  Windows, Classes, SysUtils, Dialogs, OpenGL1x, VectorTypes, VectorGeometry//,  Stuff
  ;
...
var
  ...
  Flags, SphereOffset, BoxOffset, UnkOffset, UnkOffset2: cardinal;

  numVertex, numFace, VertOffset, FaceOffset: array[0..1] of cardinal;
